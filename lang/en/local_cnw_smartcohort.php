...
$string['description'] = 'The Smart Cohort Module allows authorized users to define filtering criteria and to specify which cohort the filtered users would be added to. Fields "Name" and "Cohort" are required in the module. If the set criteria are true for the user, they get added to the cohort. Rows with blank fields are ignored by the plugin.';
...
$string['not_equals'] = 'is not equal to';
...
$string['or_if'] = 'or the <i>\'{$a}\'</i> field\'s value';
$string['to'] = 'to';
