...
$string['cnw_smartcohort:manage'] = 'Smart Cohort szabályok létrehozása, módosítása';
...
$string['addrule'] = 'Új szabály létrehozása';
$string['editrule'] = 'Szabály szerkesztése';
$string['delrule'] = 'Szabály törlése';
$string['delconfirm'] = 'Tényleg törölni szeretnéd a következő szabályt \'{$a}\'?';
$string['name'] = 'Név';
$string['email'] = 'E-mail';
...
$string['filtered_users_on'] = 'Felhasználók a következő szabályban \'{$a}\'';
...
$string['create_rule'] = 'Szabály létrehozása';
...
$string['yes'] = 'igen';
$string['no'] = 'nem';
$string['initialize_rule_cron'] = 'Szabályok inicializálása';
...
$string['rule_is_not_exist'] = 'A szabály nem létezik';
$string['anyfield'] = 'Bármely egyedi felhasználói profil';
